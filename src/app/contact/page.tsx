...
const ContactForm = () => {
    ...
    return (
        <div className="grid md:grid-cols-12 gap-10">
            ...
            >
                <h2 className="text-2xl font-semibold text-emerald-600 mb-6">Contact Information</h2>
                ...
                <motion.div variants={fadeIn} className="flex items-start mb-6">
                    ...
                    <div>
                        <h3 className="font-medium text-emerald-600 mb-1">Our Location</h3>
                ...
                <motion.div variants={fadeIn} className="flex items-start mb-6">
                    ...
                    <div>
                        <h3 className="font-medium text-emerald-600 mb-1">Phone Number</h3>
                ...
                <motion.div variants={fadeIn} className="flex items-start mb-6">
                    ...
                    <div>
                        <h3 className="font-medium text-emerald-600 mb-1">Email Address</h3>
                        <p className="text-gray-600">
                            <a href={`mailto:${contactInfo.email}`} className="hover:text-emerald-600 transition-colors">{contactInfo.email}</a>
                        </p>
                    </div>
                </motion.div>
                ...
                <motion.div variants={fadeIn} className="flex items-start">
                    ...
                    <div>
                        <h3 className="font-medium text-emerald-600 mb-1">Working Hours</h3>
                ...
                <form>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="w-full px-4 py-3 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition resize-none"
                            required
                        ></textarea>
                    </div>
...
const ContactFormFallback = () => {
    return (
        <div className="grid md:grid-cols-12 gap-10">
            <div className="md:col-span-5 bg-emerald-50 rounded-lg p-8 animate-pulse">
            ...
            <div className="md:col-span-7 bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                <div className="h-8 bg-gray-200 rounded w-1/2 mb-6"></div>
                <div className="space-y-6">
                    ...
                    <div className="h-12 bg-emerald-600 rounded w-40"></div>
                </div>
            </div>
        </div>
    );

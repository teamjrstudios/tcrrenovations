...
const AboutSection = ({nextRef}: AboutSectionProps) => {
    ...
    return (
        <section ref={nextRef} className="relative py-16 md:py-24 overflow-hidden bg-white">
            ...
            <div className="absolute top-0 left-0 w-full h-32 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-500/20 via-transparent to-transparent opacity-70 pointer-events-none" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="relative h-[500px] w-full overflow-hidden rounded-xl">
                            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-700/20 to-emerald-900/20 mix-blend-multiply z-10 rounded-xl" />
                            <Image
                                src="/about.jpg"
                                alt="TCR Renovations team"
                                fill
                        ...
                        >
                            <div className="bg-emerald-700/20 p-2 rounded-full">
                    ...
                    >
                        <motion.div variants={itemVariants}>
                            <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100 mb-2">About Us</Badge>
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Crafting Exceptional Spaces Since 2008</h2>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            variants={itemVariants}
                        >
                            Our experienced team brings decades of combined expertise to each renovation, ensuring superior results that transform your vision into reality. We believe in transparent communication and meticulous attention to detail that exceeds expectations.
                        </motion.p>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600">Skilled craftsmen with specialized expertise</p>
                                </div>
                            </div>
